...
#'
#' @export
marginal_forest <- function(X, Y, W, Z,
                          sample.fraction = 0.5,
...
#' Predict with a marginal forest.
#'
...
#' }
#'
#' @method predict marginal_forest
#' @export
predict.marginal_forest <- function(object, newdata = NULL, num.threads = NULL, ...) {
